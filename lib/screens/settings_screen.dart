...
import 'package:project_graduated/screens/change_pass_screen.dart';
      ...
      body: ListView(
        children: [
          Container(
            ...
            child: ListTile(
              leading: const Icon(IconlyLight.lock, color: Colors.blue),
              title: const Text(
                'Password Manager',
          ...
          Container(
            ...
            child: ListTile(
              leading: const Icon(IconlyLight.delete, color: Colors.blue),
              title: const Text(
                'Delete Account',
                style: TextStyle(color: Colors.black),
              ),
